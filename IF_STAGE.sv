...
/// imem 8KB cho PYNQ-Z2 demo
module imem (
    input  logic        clock,
    input  logic [13:0] addr,   // trong pipelined.sv đã đưa pc_if[15:2]
    output logic [31:0] q
);

    localparam IMEM_DEPTH = 2048; // 2048 word x 4 byte = 8KB
    ...
    initial begin
        ...
        $readmemh("lednhieuchedopipelined.mem", imem);
    end

    assign q = imem[addr[10:0]];
